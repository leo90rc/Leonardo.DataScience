...
if menu == 'Bienvenida':
    ...
    st.write('En esta web encontrarás todos los accidentes de tráfico que han sido registrados\
            ...
            del dataframe comleto si así lo deseas. ')
...
'La Dreta de l\'Eixample', 'Sant Antoni'])
...
if menu == "API":
    ...
    dataframe_accidentes = pd.read_json('http://localhost:6060/obtener_json?password=Y6571256D')
