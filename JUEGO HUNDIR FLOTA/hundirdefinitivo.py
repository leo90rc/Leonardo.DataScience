...
if __name__ == '__main__':
    ...
    def print_board():   # MUESTRA el tablero creado con los índices y columnas
...
def ubicar_barcos():    # Pregunta qué barco quiero colocar, lo coloca y lo visualiza
    ...
    system('cls||clear')
    # ACA HAY QUE UBICAR LOS BARCOS (funciones Leo)
